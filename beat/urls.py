...
urlpatterns = [
    ...
    path('delete/comment/comment_id=<int:comment_id>/album/album_id=<int:album_id>/', views.delete_comment_album, name="delete-comment-album"),
    path('delete/comment/comment_id=<int:comment_id>/music/music_id=<int:music_id>/', views.delete_comment_music, name="delete-comment-music"),
    path('delete/comment/comment_id=<int:comment_id>/video/video_id=<int:video_id>/', views.delete_comment_video, name="delete-comment-video"),
